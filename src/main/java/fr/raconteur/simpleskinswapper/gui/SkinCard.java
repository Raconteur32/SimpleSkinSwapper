...
public class SkinCard extends SpruceContainerWidget {
    ...
    public SkinCard(SkinCarouselScreen parent, SkinEntry entry, int width, int height) {
        ...
        deleteButton = new SpruceButtonWidget(
                ...
                halfW, BUTTON_HEIGHT,
                Text.translatable("simpleskinswapper.screen.carousel.delete"),
        ...
        confirmDeleteButton = new SpruceButtonWidget(
                ...
                width - BUTTON_MARGIN * 2, BUTTON_HEIGHT,
                Text.translatable("simpleskinswapper.screen.carousel.delete_confirm"),
    ...
    private Text typeLabel() {
        return Text.translatable("simpleskinswapper.screen.carousel.skin_type." + entry.skinType.getMojangVariant());
    }
