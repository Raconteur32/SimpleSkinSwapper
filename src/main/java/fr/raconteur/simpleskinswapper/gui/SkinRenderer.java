...
public class SkinRenderer {
     ...
     */
    public static void renderPlayerFollowingMouse(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, int size, PlayerSkin skin, int mouseX, int mouseY) {
     ...
     */
    public static void renderPlayerRotatable(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, int size, PlayerSkin skin, float yawDegrees, float pitchDegrees) {
    ...
    private static void renderState(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, int size, AvatarRenderState state, Quaternionf rotation, Vector3f translation) {
