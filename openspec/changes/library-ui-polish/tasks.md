...
- [ ] 2. Footer: lift `gridBottom` to reserve the footer band; spread the three 110px buttons across the panel width (left/center/right); commit
- [ ] 3. Lang keys: restore `simpleskinswapper.screen.library.add_category` as "New Category" / "Nouvelle catégorie"; increment logic at the creation call site; `./gradlew build detektAll` green; commit
