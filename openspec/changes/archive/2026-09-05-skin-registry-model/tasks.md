...
- [x] 10. GUI: dynamic delete dialog, detail panel global + per-category name fields (rename never touches files), legacy stores retired; full build + `detektAll` green; commit
